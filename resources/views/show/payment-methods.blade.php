...
<div class="row">
    <div class="col-md-8">
        <div class="panel panel-default">
            <div class="panel-heading">All Payment Methods</div>

            <div class="panel-body">
                <form action="{{url('/updatePaymentMethod')}}" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        <input type="text" required="required" name="title" class="form-control" placeholder="Payment method name (for delete)">
                    </div>
                    <div class="form-group">
