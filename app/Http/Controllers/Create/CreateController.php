...
class CreateController extends Controller
{
    ...
    public function createTransactionAction(Request $request)
    {
	    ...
	    if ( isset( $checkCaseId['exists'] ) && $checkCaseId['exists'] == 1 ) {
		    Session::flash('message_error', 'This Case ID already exist on another client');
		    Session::set('case_id', $request->case_id);
		    Session::set('client_name', $request->client_name);
		    Session::set('total_price', $request->total_price);
